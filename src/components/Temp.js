! function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("react")) : "function" == typeof define && define.amd ? define(["react"], t) : "object" == typeof exports ? exports.Picker = t(require("react")) : e.Picker = t(e.React)
}(this, function (e) {
    return function (e) {
        function t(r) {
        ...
        var h = function (e) {
            function t(e) {
                ...
                return d.call(n), n.state = s({
                    isMoving: !1,
                    startTouchY: 0,
                    startScrollerTranslate: 0
                }, n.computeTranslate(e)), n
            }
            return a(t, e), c(t, [{
                ...
                value: function () {
                    var e = this.props,
                        ...
                        n = e.itemHeight,
                        r = this.state,
                        o = r.scrollerTranslate,
                        i = r.minTranslate,
                        a = r.maxTranslate,
                        s = void 0;
                    s = o > a ? 0 : o < i ? t.length - 1 : -Math.floor((o - a) / n), this.onValueSelected(t[s])
                }
            }, {
                key: "postWheel",
                value: function () {
                    var e = this,
                        t = this;
                    setTimeout(function () {
                        return t.state.isScrolling > Date.now() - 250 ? void e.postWheel() : void e.postMove()
                    }, 250)
                }
            }, {
                key: "renderItems",
                value: function () {
                    ...
                    return n.map(function (t, n) {
                        var i = {
                            ...
                            a = "picker-item" + (t === o ? " picker-item-selected" : "");
                ...
                key: "render",
                value: function () {
                    var e = this.props.tabIndex,
                        t = "translate3d(0, " + this.state.scrollerTranslate + "px, 0)",
                        n = {
                            MsTransform: t,
                            MozTransform: t,
                            OTransform: t,
                    ...
                    return this.state.isMoving && (n.transitionDuration = "0ms"), u.default.createElement("div", {
        ...
        h.propTypes = {
            ...
            value: f.default.any.isRequired,
            itemHeight: f.default.number.isRequired,
            columnHeight: f.default.number.isRequired,
            onChange: f.default.func.isRequired,
            tabIndex: f.default.number.isRequired
        };
        var d = function () {
                var e = this;
                this.computeTranslate = function (t) {
                    var n = t.options,
                        ...
                        i = t.columnHeight,
                        a = n.indexOf(r);
                    return a < 0 && (console.warn('Warning: "' + e.props.name + '" doesn\'t contain an option of "' + r + '".'), e.onValueSelected(n[0]), a = 0), {
                        scrollerTranslate: i / 2 - o / 2 - a * o,
                        minTranslate: i / 2 - o * n.length + o / 2,
                        maxTranslate: i / 2 - o / 2
                    }
                    ...
                    var n = void 0;
                    n = !t.keyCode || 38 != t.keyCode && 40 != t.keyCode ? t.deltaY ? t.deltaY : 0 : 38 == t.keyCode ? 53 : -53, e.setState(function (t) {
                        var r = t.scrollerTranslate,
                            o = t.minTranslate,
                            i = t.maxTranslate,
                            a = ((r || 0) + Math.round(n), Math.max(o, Math.min(i, (r || 0) + Math.round(n))));
                        return e.postWheel(), {
                            scrollerTranslate: a,
                ...
                return a(t, e), c(t, [{
                    ...
                    value: function () {
                        var e = this.props,
                            ...
                            s = 1e3,
                            c = [];
                        for (var l in t) c.push(u.default.createElement(h, {
                            tabIndex: s++,
                            key: l,
                            name: l,
                            options: t[l],
        ...
        v.propTyps = {
            optionGroups: f.default.object.isRequired,
            valueGroups: f.default.object.isRequired,
            onChange: f.default.func.isRequired,
            itemHeight: f.default.number,
        ...
        function l(e, t) {
            ...
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = c(t), r = f.bind(null, n), o = function () {
